...
import ImgMain from '../img/poster/strangerThings.jpg'
...
import ImgTrailer from '../img/poster/sp16-9.jpeg'

function DetailSerial() {
    return (  
            ...
            <section className='max-[1100px]:pb-20 bg-[url(../img/bg.png)] bg-no-repeat bg-cover bg-center w-full min-[1100px]:h-screen md:min-h-[800px] flex flex-col justify-center relative after:absolute after:top-0 after:left-0 after:backdrop-blur-md after:z-20 after:w-full after:h-full'>
                <div className="container flex max-[1100px]:flex-col gap-x-20 items-center z-50">
                    ...
                    <div className="max-[1100px]:mt-10 w-[70%] max-[1100px]:w-full">
                        ...
                        <h1 className='md:text-[50px] text-4xl font-bold w-fit my-4 leading-[1.1]'>Человек-бензопила</h1>
                        ...
                        <ul className='flex md:flex-row flex-col gap-x-8 gap-y-2 md:items-center'>
                            <li><Link to="/actors/" className='text-white hover:text-[#CAE962] transition-all duration-300'>Вайнона Райдер</Link></li>
                            <li><Link to="/actors/" className='text-white hover:text-[#CAE962] transition-all duration-300'>Дэвид Харбор</Link></li>
                        </ul>
                        <button className='mt-8 flex gap-2 justify-center items-center group py-3 px-8 rounded-lg hover:scale-110 bg-[#CAE962]/80 relative overflow-hidden transition-all duration-700'>
                    ...
                    <Tab.Panel>
                        <div className="xl:w-2/5 md:w-4/5 px-5 md:px-0 mx-auto pb-10">
                            <p className='text-[#8C8C8C]'>
                                После воссоединения с Гвен Стейси дружелюбный сосед Человек-Паук попадает из Бруклина в Мультивселенную, где встречает команду Паучков, 
                                защищающих само её существование. Пытаясь справиться с новой угрозой, Майлз сталкивается с Пауками из других вселенных. 
                                Настаёт момент, когда ему необходимо решить, что значит быть героем, спасающим тех, кого любишь больше всего.
                            </p>
                            ...
                            <ul className='flex flex-col divide-y-[1px] divide-[#dee2e6]/20 mt-12'>
                                <li className='flex xs:flex-row flex-col gap-y-1 py-2.5'>
                                    ...
                                    <span className='xs:w-1/2 xs:text-base text-sm'>2023</span>
                                </li>
                                <li className='flex xs:flex-row flex-col gap-y-1 py-2.5'>
                                    <span className='text-[#8C8C8C] xs:w-1/2'>Жанр</span>
                                    <span className='xs:w-1/2 xs:text-base text-sm'>Ужасы, Фантастика, Триллер, Драма</span>
                                </li>
                                <li className='flex xs:flex-row flex-col gap-y-1 py-2.5'>
                                    <span className='text-[#8C8C8C] xs:w-1/2'>Количество сезонов</span>
                                    <span className='xs:w-1/2 xs:text-base text-sm'>1-4</span>
                                </li>
                            </ul>
                        </div>
                    </Tab.Panel>
                        ...
                        <div className='bg-[#161618] lg:py-[120px] md:py-14 py-8'>
                            <div className="xl:w-2/5 md:w-4/5 px-5 md:px-0 mx-auto">
                                <form method='POST' className=" flex flex-col">
                                    ...
                                    <button type='submit' className="group hover:scale-105 transition-all duration-500 overflow-hidden flex justify-center items-center relative bg-[#CAE962] py-2.5 px-8 min-[600px]:w-fit w-full rounded-lg cursor-pointer mt-10">
