                ...
                <div className="container flex max-[1100px]:flex-col gap-x-20 items-center z-50">
                    ...
                    <div className="max-[1100px]:mt-10 w-[70%] max-[1100px]:w-full">
                        <div className="flex md:flex-col flex-row items-center md:items-start gap-x-2">
                            <div className="rounded-lg backdrop-blur-md h-fit bg-black/20 w-fit px-2.5 py-1 text-[#BFBFBF] text-sm">Ужасы</div>
                        ...
                        <h1 className='md:text-[50px] text-4xl font-bold w-fit my-4 leading-[1.1]'>Очень странные дела</h1>
                        ...
                        <ul className='flex md:flex-row flex-col gap-x-8 gap-y-2 md:items-center'>
                            <li><Link to="/actors/" className='text-white hover:text-[#ff1414] transition-all duration-300'>Вайнона Райдер</Link></li>
                            <li><Link to="/actors/" className='text-white hover:text-[#ff1414] transition-all duration-300'>Дэвид Харбор</Link></li>
                        </ul>
