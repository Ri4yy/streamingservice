...
import StrThings from '../img/poster/strangerThings.jpg'
    ...
    return (
        <main className='-mt-20'>
            <section className='lg:px-[80px] md:px-10 px-5 pt-[100px]'>
                <div className="bg-[url(../img/poster/strTh.webp)] bg-center bg-cover rounded-2xl h-[700px] w-full relative">
                    <div className="absolute md:bottom-5 md:left-5 md:right-5 bottom-0 px-4 py-2.5 bg-black/60 backdrop-blur-md rounded-xl lg:max-w-[700px]">
                        <p className='md:text-3xl text-xl font-medium mb-4'>Очень страные дела</p>
                        <p className='md:text-base text-xs'>1980-е годы, тихий провинциальный американский городок. Благоприятное течение местной жизни нарушает загадочное исчезновение подростка
                            по имени Уилл. Выяснить обстоятельства дела полны решимости родные мальчика и местный шериф, также события затрагивают лучшего друга Уилла – Майка.
                            Он начинает собственное расследование. Майк уверен, что близок к разгадке, и теперь ему предстоит оказаться в эпицентре ожесточенной битвы потусторонних сил.</p>
                    </div>
                </div>
            </section>
            ...
            <section className='container lg:py-[120px] md:py-14 py-8'>
                ...
                <div className="grid xl:grid-cols-4 lg:grid-cols-3 xs:grid-cols-2 mt-20 gap-x-5 gap-y-9">
                    <CardSerials name="Очень странные дела" year="2023" genre="Фантастика" rate="8.4" img={StrThings} />
                    <CardSerials name="Очень странные дела" year="2023" genre="Фантастика" rate="8.4" img={StrThings} />
                    <CardSerials name="Очень странные дела" year="2023" genre="Фантастика" rate="8.4" img={StrThings} />
                    <CardSerials name="Очень странные дела" year="2023" genre="Фантастика" rate="8.4" img={StrThings} />
                    <CardSerials name="Очень странные дела" year="2023" genre="Фантастика" rate="8.4" img={StrThings} />
